    ...
    try:
        ...
        if json_match:
            try:
                ...
                return [{"question": "Error parsing response", "options": ["A. Error", "B. Error", "C. Error", "D. Error"], "answer": "A", "explanation": "API error"}]
        return [{"question": "Error generating questions", "options": ["A. Error", "B. Error", "C. Error", "D. Error"], "answer": "A", "explanation": "API error"}]
